...
const inputGroupButtonVariants = cva(
  "gap-2 rounded-md /relaxed shadow-none flex items-center",
  {
    variants: {
      size: {
...
function InputGroupText({ className, ...props }: React.ComponentProps<"span">) {
  return (
    <span
      className={cn(
        "text-muted-foreground gap-2 /relaxed [&_svg:not([class*='size-'])]:size-4 flex items-center [&_svg]:pointer-events-none",
        className,
      )}
      {...props}
    />
